...
class IndexCompopent extends Component {
    render() {
        return (
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="tile">
                            ...
                            <p className="mt-4 mb-4"><a className="btn btn-primary mr-2 mb-2" href="http://pratikborsadiya.in/blog/vali-admin" target="_blank"><i className="fa fa-file" />Docs</a><a className="btn btn-info mr-2 mb-2" href="https://github.com/pratikborsadiya/vali-admin" target="_blank"><i className="fa fa-github" />GitHub</a><a className="btn btn-success mr-2 mb-2" href="https://github.com/pratikborsadiya/vali-admin/archive/master.zip" target="_blank"><i className="fa fa-download" />Download</a></p>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="tile">
